...
export const CONSTANTS: CONSTANTS_TYPE = {
  ...
  REFRESH_JWT_EXPIRES_IN: process.env.JWT_EXPIRES_IN as CONSTANTS_TYPE['REFRESH_JWT_EXPIRES_IN'] || '7d',
...
export const MONEY_NUMBER_REGEX = new RegExp(
  `^(0|[1-9]\\d*)(?:\\.\\d{1,${CONSTANTS.AMOUNT_SCALE}})?$`,
);
